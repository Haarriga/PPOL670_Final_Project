...
ggplot(data = data_training, 
  ...
  labs(title = "Educational attainment & Income are highly correlated",
...
ggplot(data = data_training, 
  ...
  labs(title = "The distribution of Child Tax Credit is skewed & clustered",
...
ggplot(data = data_training, 
  ...
  geom_density(alpha=.2, fill="#FF6666") +
  scale_x_continuous(limits = c(0,20000))+
  labs(title = "The distribution of work and child care expenses is skewed",
...
Personal income, the work and child total expenses, education attainment, whether the individual had health insurance last year, and the marital status are the most importance variables in predicting individual's labor status. 
...
g2 <- ggplot(data = data_training) +
  ...
  scale_x_discrete(name ="Labor Status",
                  labels = c("Not in labor force", 
                              "In labor force")) +
  labs(title = "Positive effects of work and child care expenses on labor status",
       x = "labor status",
       y= "SPM unit's capped work and child care expenses ($ Thousand)", 
       caption="Data scource: Census.gov") +
  theme(plot.title = element_text(size=10))
...
g3 <- ggplot(data = data_training) +
  ...
  scale_fill_discrete(name ="labor status",
                   labels = c("Not in labor force", "In labor force")) +
  labs(title = "Positive effects of education attainment on labor status",
...
g4 <- ggplot(data = data_training) +
  geom_bar(aes(x = factor(COV), fill = in_labor)) + 
  scale_fill_discrete(name = "Labor Status",
                   labels = c("Not in labor force", 
                              "In labor force")) +
  labs(title = "Positive effects of health insurance coverage on labor status",
       x = "Whether the individual had health insurance coverage last year",
       caption="Data scource: Census.gov") +
  theme(plot.title = element_text(size=10))

#A_MARITL and in_labor 
g5 <- ggplot(data = data_training) +
